    document.addEventListener("DOMContentLoaded", function() {
      const testimonials1 = [
        ...
        { name: "Riden Smash", server: "Phoenix", text: "thank you" },
        { name: "Felix Cragsnow", server: "Phantom", text: "Such a nice atmosphere!! Everyone is so welcoming <3" },
        { name: "Aoi Sharok", server: "Louisoix", text: "Very lovely Bar and super cool puzzles!" },
        { name: "Kuga Sakusa", server: "Spriggan", text: "Very fun place and nice people :)" },
        { name: "Yuno Yuake", server: "Phantom", text: "Love the place ♥" },
        { name: "Rizu Mochizuki", server: "Omega", text: "Came for the drinks, returned for the company." },
        { name: "Ahissa Chocolate", server: "Sagittarius", text: "I couldn't hide in the wall and the bartender tossed me at some eclipse lesbian 10/10" },
        { name: "Leo Himawari", server: "Alpha", text: "It's so beautiful here really great♥ I'm leaving a sunflower here" },
        { name: "Moka Kurimu", server: "Spriggan", text: "Always the best service, and lovely place <3" },
        { name: "Astrid Styrngeim", server: "Louisoix", text: "fantasticly decorated with great service" },
        { name: "Tempest Obscura", server: "Sagittarius", text: "The beautiful atmosphere is only matched by the beautiful service. 10/10" },
        { name: "Meta Cloviz", server: "Sagittarius", text: "Awesomeeee" },
        { name: "Akio Takeru", server: "Shiva", text: "First time seeing this place and its content! Can recommend 12/10. Will come back surely! Keep it up, well done everyone :D" },
        { name: "Akatosh Xaela", server: "Sagittarius", text: "once again this place is great, i will try and vist more often now i know this place exists :)" },
        { name: "Reinhardt Belmont", server: "Alpha", text: "really well made place and the jumping puzzles are fantastic" },
        { name: "Larxene Awandah", server: "Sagittarius", text: "Larxenne estuvo aqui!" },
        { name: "Tsuyoshi Kido", server: "Sagittarius", text: "hope this is a good night to puzzle jumps!" },
        { name: "Marble Top", server: "Sagittarius", text: "Very nice spot!" },
        { name: "Hazel Snow", server: "Phantom", text: "Awesome place. ♥" },
        { name: "Pheebs Chomp", server: "Louisoix", text: "Fun staff, drunk fish, cute brid! love the design of this place! Had a great night thank you!" },
        { name: "Yehren Cizha", server: "Omega", text: "An au'ra a day keeps the Quen away" },
        { name: "Lissandra Blue", server: "Louisoix", text: "I like it a lot. Good work :)" },
        { name: "Yukina Randuin", server: "Ragnarok", text: "really nice place you have here. Love how you made the idea of a tropical paradise come true. Great people with a good idea! Keep it going ♥" },
        { name: "The Barista", server: "Cerberus", text: "Definitely enjoyed my cocktail :)" },
        { name: "Anna Pancakes", server: "Cerberus", text: "Lagre fimsh" },
        { name: "Naomi Glover", server: "Cerberus", text: "fish" },
        { name: "Lelo Naweh", server: "Phantom", text: "Suuper cosy chill place, also very pretty♥" },
        { name: "Genkei Zero", server: "Sagittarius", text: "Warm~" },
        { name: "Harley Kor-duun", server: "Sagittarius", text: "Nice place to chill and have a fun chat" },
        { name: "Vindir Snowleaf", server: "Louisoix", text: "Nice place, i took all the alcohol." },
        { name: "Quenjamin Banklin", server: "Sagittarius", text: "I'm a short king with a small sword, period." },
        { name: "Mazie May", server: "Sagittarius", text: "Just observing Welkin & Quen measuring their swords- let that picture slowly sip through" },
        { name: "Agora Innuego", server: "Sagittarius", text: "Kitty Mango: i'm sorry I have wrongchair syndrome AHAHAHAHAHAHAHAHAHA" },
        { name: "Vic Tim", server: "Moogle", text: "pas mal" },
        { name: "Alicia Knight", server: "Phantom", text: "this guy likes Tau, what a weeb" },
        { name: "Silly Banana", server: "Twintania", text: "I love it!!" },
        ...
        { name: "Feyne Mier", server: "Omega", text: "This place looks awesome, love it. Also Room 9 is so pretty! :3" },
        { name: "Lolopo Lopo", server: "Zodiark", text: "Excellent decoration sense, sunken bar under the stars is inspirational." },
        { name: "Ino Nara", server: "Phantom", text: "Wonderful bar design, 10/10 i love it!" },
        { name: "Ladonia Kisne ", server: "Phantom", text: "This is a very pretty tiki bar!" },
        { name: "Kelin Draumur", server: "Shiva", text: "The most wonderfull bar in Eorzea !!! I'm fan ! I love you!!!" },
        { name: "El Harg", server: "Phantom", text: "some of the best roast chicken around" },
        { name: "Minka Miez", server: "Omega", text: "All's Well that Ends in the Well :3" }, 
        { name: "Yoso Fukiku", server: "Omega", text: "Lalas dont deserve to exist" },
        { name: "Pomhub Ceo", server: "Sagittarius", text: "floor inspec'd" }, 
        { name: "Jammers Moghecker", server: "Ragnarok", text: "I enjoyed the Dragon fruit Magenta, highly suggest trying." }, 
        { name: "Megumin Kun", server: "Omega", text: "Megu was here >:3 CHAAAAA" },
        { name: "Melody Potter", server: "Sagittarius", text: "Beautiful place, even better host, even got me vodka xDD" },
        { name: "Manafrontal Lobotomy", server: "Sagittarius", text: "Tiki Namazu Yes, please." },
        { name: "Indy Jones", server: "Raiden", text: "Best looking and cosiest bar I've ever seen. Staff are very nice too" },
        { name: "Hahaulu Nonoulu", server: "Phantom", text: "Sorry for disappearing, Internet got sleepy XD" },
        { name: "Agora Innuego", server: "Sagittarius", text: "The bartender is nice and helpful." },
        { name: "Pomhub Ceo", server: "Sagittarius", text: "floor inspector is bacc" },
        { name: "Lalayi Layi", server: "Shiva", text: "book" },
      ...
      const testimonials2 = [
        { name: "Raelynn Tirasch", server: "Phantom", text: "Very exciting. A lot of fun! :D" },
        { name: "Rosa Diaz", server: "Phantom", text: "cant find the Red Doll but found the cake and the secret room :D" },
